...
// Define C  ollision Parameters
#define COLLISION_FILTER "ground_plane::link::collision"
#define COLLISION_ITEM   "tube::tube_link::tube_collision"
#define COLLISION_POINT  "arm::gripperbase::gripper_link"
#define COLLISION_ARM1  "arm::link1::collision1"
#define COLLISION_ARM2  "arm::link2::collision2"
...
bool ArmPlugin::createAgent()
{
	...
	/
	*/
	agent = dqnAgent::Create(INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS, NUM_ACTIONS,OPTIMIZER, LEARNING_RATE, REPLAY_MEMORY, BATCH_SIZE, 
...
void ArmPlugin::onCollisionMsg(ConstContactsPtr &contacts)
{
	...
	for (unsigned int i = 0; i < contacts->contact_size(); ++i)
	{
		...
		/
		*/
		//((strcmp(contacts->contact(i).collision1().c_str(), COLLISION_ITEM) == 0) && (strcmp(contacts->contact(i).collision2().c_str(),  COLLISION_ITEM) != 0))
		//if ((strcmp(contacts->contact(i).collision1().c_str(), COLLISION_POINT) == 0) && (strcmp(contacts->contact(i).collision2().c_str(),  COLLISION_ITEM) != 0))
...
void ArmPlugin::OnUpdate(const common::UpdateInfo& updateInfo)
{
	...
	if( hadNewState && !newReward )
	{
		...
		const float groundContact = 0.001f;
